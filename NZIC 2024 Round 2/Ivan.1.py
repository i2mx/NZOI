...
# TODO: Cheese the y=0 case by doing a 2 way binary search
...
# DISTANCES THAT NEED TO BE CONSIDERED

# The computations alone are taking too long
...
#     distances = []
#     for city in cities:
#         distances.append(cost(cities[s], city))

#     # TODO: SORT THIS
#     # distances.sort()
#     pre_compute[s] = distances
...
for i in range(len(stops)):
    ...
    # a = bisect.bisect_right(pre_compute[s], C)
    # print(a - 1, end=' ')
